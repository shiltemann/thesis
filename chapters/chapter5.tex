...
\newpage
\phantomsection
\addcontentsline{toc}{section}{The Informatics: GmT}
...
\caption{Conceptual view of the GmT mothur MiSeq SOP pipeline.}
\label{end-to-end}
\end{figure}

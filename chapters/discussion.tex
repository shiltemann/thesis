...
\subsection{Sustainability of bioinformatics tools}
As this work demonstrates, even with a strong focus on and passion for creating FAIR and accessible bioinformatics tools, ensuring the long-term availability of tools is a real challenge. In some cases the tools simply become obsolete, as the field of bioinformatics has moved on (e.g. the Complete Genomics tools). In other cases, tool maintenance is abandoned in favor of a novel, superior solution (e.g. iReport-like functionality has now been adopted and adapted into Galaxy itself). In yet other cases, the platforms originally used for sharing and hosting of the tools have since been disbanded (e.g. the CTMM-TraIT Tool Shed). While in such cases a new home can be found for the tools (I've moved the tools to the main Galaxy Tool Shed), the links provided in the publication and other descriptions of the work will forever be defunct. In order to minimize the chances of this occurring, it is important to identify solutions with a high probability of long-term support. This is not straightforward as many underlying factors are not transparent (e.g. stability of funding). One possible indicator of the health of a project could be the size and activity of the user community around it. A project with a very active developer and user community around it is more likely to survive long-term.

Furthermore, in this digital age, a shift toward viewing scientific publications as \emph{living documents} could aid in the sustainability of scientific tools and analyses.
If I had been provided the opportunity to submit revisions to publications even after final acceptance, I would have been able to update the links to tools and other resources after they had been moved to a new home.
Similarly, authors of publications are often unreachable after they change jobs and lose access to their institutional email address they are often encouraged to provide as contact information for publications.
Being able to submit post-publication revisions as implementation details change or tools are updated would increase long-term sustainability of bioinformatics tools and scientific analyses in general.
Of course when significant revisions are made to a publication in this way, a novel round of peer review may be required, but there is no reason this should not be possible.
An encouraging first step towards such a stepwise revision approach to publication is the rise in journals employing completely open peer-review process; submissions to journals like F1000 \cite{f1000} are open from day 1 (similar to a preprint server), and as peer review are added and responded to, authors submit revisions and reviewers re-review.
This process is completely open, and the full revision history of a publication is thus publicly available.
Once a paper reaches a sufficient number of acceptances by reviewers, the publication is considered accepted.
This approach is analogous to version-controlled software, and has the potential to transform the way we view scientific publications for the better.

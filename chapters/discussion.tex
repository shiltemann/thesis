...
The Galaxy project~\cite{giardine2005galaxy,blankenberg2010galaxy,afgan2016galaxy} enables researchers to run complex data analysis without programming expertise, directly from their web browser. While there are several workflow management systems (TODO, cite from, taverna, \url{https://en.wikipedia.org/wiki/Bioinformatics_workflow_management_system}), some of these are commercial and may not be affordable to many labs (CLCbio), or still require local installation (), or closed-source (), meaning only the core development team can provide updates to the platform.

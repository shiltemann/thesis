...
- easy to use (galaxy)
- easy to install and maintain (conda, galaxy)
- reproducible results (galaxy, conda)
- importance of visualization (circos)
- reporting of results
- good training (gtn)

- tool selection (many choices for tools, can have great impact on final results, poor overlap typically)

\newpage
\section{Use case 1: Prostate Cancer}

\begin{color}{chaptergrey}
\hfill I like puzzles. Any type of puzzle. I always have. If I see a puzzle or a problem I have to solve it. I think that is what makes cancer such a fascinating topic for me.

\hfill Imagine you are given a jigsaw puzzle. Now instead of a few hundred pieces, there are several billion pieces. The picture on the box is not a picture of the puzzle inside the box,
...
\paragraph{The Bio}
\subparagraph{Small variants} comprise the simplest class of mutations; those consisting of alterations of just a handful of bases, for instance the \emph{substitution}, \emph{deletion} or \emph{insertion} of one or more nucleotides.
...
\subparagraph{Structural variations}
rarely involve the coding sequences directly, only observed through WGS
\subparagraph{Clonality}
\subparagraph{Temporal Evolution}
\subparagraph{Epigenetics}

\paragraph{The Informatics}

...
%This involved the incorporation of the Galaxy  mothur Toolkit (GmT), a suite of 125+ Galaxy tools based on the mothur \cite{}  tool suite for 16S analysis, augmented by a set of custom tools developed specifically for the Streeklab Haarlem experimental setup.

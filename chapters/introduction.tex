...
\node[opacity=0.8,inner sep=0pt] at (current page.center){\includegraphics[width=\paperwidth,height=\paperheight]{chapters/images/background-texture-blue.jpg}};
\sc
\begin{center}

\color{white}{\Large The Jigsaw Genome \normalsize
\vspace{2cm}
...
\begin{minipage}{5in}
\tikz[remember picture,overlay]
\node[opacity=0.7,inner sep=0pt] at (current page.center){\includegraphics[width=\paperwidth,height=\paperheight]{chapters/images/background-texture-blue.jpg}};
\sc
\begin{center}

\color{white}{\Large The Human Microbiome \normalsize
\vspace{1cm}

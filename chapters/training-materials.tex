...
\articletitle{Community-driven data analysis \\training for biology}
Saskia Hiltemann\textsuperscript{\ref{gtn-affil:emc2}*},
Bérénice Batut\textsuperscript{\ref{gtn-affil:freiburg}*},
Andrea Bagnacani\textsuperscript{\ref{gtn-affil:rostock}},
Dannon Baker\textsuperscript{\ref{gtn-affil:hopkins}},
Clemens Blank\textsuperscript{\ref{gtn-affil:freiburg}},
Anthony Bretaudeau\textsuperscript{\ref{gtn-affil:abretaud}},
Loraine Brillet-Guéguen\textsuperscript{\ref{gtn-affil:roscoff}},
Martin Čech\textsuperscript{\ref{gtn-affil:pennstate}},
John Chilton\textsuperscript{\ref{gtn-affil:pennstate}},
Dave Clements\textsuperscript{\ref{gtn-affil:hopkins}},
Olivia Doppelt-Azeroual\textsuperscript{\ref{gtn-affil:pasteur}},
Anika Erxleben\textsuperscript{\ref{gtn-affil:freiburg}},
Mallory Ann Freeberg\textsuperscript{\ref{gtn-affil:ebi}},
Simon Gladman\textsuperscript{\ref{gtn-affil:melbourne}},
Youri Hoogstrate\textsuperscript{\ref{gtn-affil:emc2}},
Hans-Rudolf Hotz\textsuperscript{\ref{gtn-affil:basel}},
Torsten Houwaart\textsuperscript{\ref{gtn-affil:freiburg}},
Pratik Jagtap\textsuperscript{\ref{gtn-affil:minnesota}},
Delphine Larivière\textsuperscript{\ref{gtn-affil:pennstate}},
Gildas Le Corguillé\textsuperscript{\ref{gtn-affil:roscoff}},
Thomas Manke\textsuperscript{\ref{gtn-affil:maxplanck}},
Fabien Mareuil\textsuperscript{\ref{gtn-affil:pasteur}},
Fidel Ramírez\textsuperscript{\ref{gtn-affil:maxplanck}},
Devon Ryan\textsuperscript{\ref{gtn-affil:maxplanck}},
Florian Christoph Sigloch\textsuperscript{\ref{gtn-affil:freiburg}},
Nicola Soranzo\textsuperscript{\ref{gtn-affil:earlham}},
Joachim Wolff\textsuperscript{\ref{gtn-affil:freiburg}},
Pavankumar Videm\textsuperscript{\ref{gtn-affil:freiburg}},
Markus Wolfien\textsuperscript{\ref{gtn-affil:rostock}},
Aisanjiang Wubuli\textsuperscript{\ref{gtn-affil:leibniz}},
Dilmurat Yusuf\textsuperscript{\ref{gtn-affil:freiburg}},
Galaxy Training Network\textsuperscript{\ref{gtn-affil:gtn}},
Rolf Backofen\textsuperscript{\ref{gtn-affil:freiburg}},
Anton Nekrutenko\textsuperscript{\ref{gtn-affil:pennstate}},
Björn Grüning\textsuperscript{\ref{gtn-affil:freiburg}}
...
\begin{enumerate}
\itemsep-0.5em
\item Albert-Ludwigs-University, Freiburg  Germany. \label{gtn-affil:freiburg}
\item Erasmus Medical Centre, Rotterdam, The Netherlands. \label{gtn-affil:emc2}
\item Department of Systems Biology and Bioinformatics, University of Rostock, Rostock, Germany. \label{gtn-affil:rostock}
\item INRA, UMR IGEPP, BIPAA/GenOuest, Campus Beaulieu, Rennes, France. \label{gtn-affil:abretaud}
\item CNRS, UMPC, FR2424, ABiMS, Station Biologique, Roscoff, France. \label{gtn-affil:roscoff}
\item The Pennsylvania State University, University Park, PA, USA. \label{gtn-affil:pennstate}
\item Johns Hopkins University, Baltimore MD USA. \label{gtn-affil:hopkins}
\item Bioinformatics and Biostatistics HUB, Centre de Bioinformatique, Biostatistique et Biologie Integrative (C3BI, USR 3756 Institut Pasteur et CNRS) – Paris, France. \label{gtn-affil:pasteur}
\item European Bioinformatics Institute, Hinxton, Cambridge, UK. \label{gtn-affil:ebi}
\item Melbourne Bioinformatics, The University of Melbourne, Australia. \label{gtn-affil:melbourne}
\item Friedrich Miescher Institute for Biomedical Research, Basel, Switzerland. \label{gtn-affil:basel}
\item Biochemistry, Molecular Biology and Biophysics, University of Minnesota Medical School, Minneapolis, USA. \label{gtn-affil:minnesota}
\item Max Planck Institute of Immunobiology and Epigenetics, Freiburg, Germany. \label{gtn-affil:maxplanck}
\item Earlham Institute, Norwich, UK. \label{gtn-affil:earlham}
\item Leibniz Institute for Farm Animal Biology (FBN), Dummerstorf, Germany. \label{gtn-affil:leibniz}
\item https://galaxyproject.org/teach/gtn/ \label{gtn-affil:gtn}
...
\begin{table}{}
    ...
    \hline
    \ \\
    Server Administration & Admin & Galaxy Database schema, Docker and Galaxy, Advanced customisation of a Galaxy instance \\
...
\begin{figure}[th!]
    \centering
    \includegraphics[width=300pt]{chapters/images/training/training-figure-stats.png}

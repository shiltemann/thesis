...
% 'bleed' / 'afloopgebied' toevoegen: "https://tex.stackexchange.com/questions/178653/add-bleed-using-geometry"
% verander pdf naar 18*25
% verander margins naar 2.5cm
% dan heb je netto marges van 2.0cm en aan beide kanten 5mm ruimte om te snijden
% "Als vlakken, foto’s en andere beeldelementen door moeten lopen tot de rand van de pagina, moet de opmaak ‘aflopend’ gemaakt worden. Dit doet u door de opmaak minimaal 3 mm door te laten lopen buiten het eindformaat."
% -> minimaal 3mm
% afstand van pagina nummers tot aan rand: 1.75cm

\usepackage[paperwidth=18.0cm, paperheight=25.0cm, left=2.5cm,right=2.5cm,bottom=2.5cm,top=2.5cm]{geometry}
...
\ifodd\value{page} %
  ...
  \tikz\node[fill=gray!30,anchor=west,text width=\LabelSize,
    align=center,text height=20pt,text depth=10pt,font=\large\sffamily] {\thechapter};
  }%
 }
 \else
 \backgroundsetup{
